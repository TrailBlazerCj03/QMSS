...
setwd("C:/Users/Michael Parrott/Documents/RpackageExample")
...
#===Including accessible data in package===#
  ...
  setwd("./data")
  x <- c(1:10)
  save(x,file="x.RData") #rdata file should have same name as single data object within file
...
# To allow users access to data when you library is loaded  
  usethis::use_data(x, mtcars, internal = FALSE,overwrite=TRUE) #set overwrite=TRUE, to overwrite file and make updates.
